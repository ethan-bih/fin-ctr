  ...
  return (
    <div className="space-y-6 animate-fade-in pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">Quản Lý Hạn Mức Chi Tiêu</h2>
          <p className="text-sm text-slate-500">Đặt hạn mức ngân sách hàng tháng cho từng danh mục để tránh vượt chi</p>
        </div>
        <button
          onClick={() => setIsAdding(!isAdding)}
          className="flex items-center space-x-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold px-4 py-2.5 rounded-xl shadow-xs transition-all self-start sm:self-auto"
        >
